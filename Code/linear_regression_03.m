...
x_train = [ones(size(x_train_initial)), x_train_initial, x_train_initial .^2];
x_test = [ones(size(x_test_initial)), x_test_initial, x_test_initial .^2];
